1. Copy `Service-KeyKeeperApi` and `Service-KeyKeeperApi-Worker` to the https://github.com/swisschain/kubernetes-swisschain/tree/master/Kubernetes/03.Pods/Sirius. 
